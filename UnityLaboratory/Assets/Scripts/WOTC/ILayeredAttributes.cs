...
/// current attribute.
/// </summary>
public interface ILayeredAttributes
{
    /// <summary>
    ...
    void SetBaseAttribute(AttributeKey attribute, int value);
    ...
    int GetCurrentAttribute(AttributeKey attribute);
...
// VERSION DETAILS: C#InterviewPreScreen v1.2 2022-09-21